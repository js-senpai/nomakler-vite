...
export default ({
  apartments = [],
  ...props
}: ActualApartmentsProps): JSX.Element => {
  return (
    <section className="actual-apartments" {...props}>
      <DefaultContainer className="actual-apartments__container">
        <h2
          className="actual-apartments__title"
          dangerouslySetInnerHTML={{
            __html: `The <span class='blue-text'>#1</span> Site for Renters`,
          }}
        />
        <div className="actual-apartments__description">
